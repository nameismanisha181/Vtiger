...
public class retryAnalyserForCreateContact extends BaseClass
{
	...
	//	Assert.assertEquals(contactHeader.contains(LastName), true);
		...
		//Failing this test cases for use of retry Analyser
		Assert.assertEquals(contactHeader.contains(LastName), false);
